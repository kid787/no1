//+------------------------------------------------------------------+
//|                                       XAUUSD_Fintokei_EA_v6.mq5 |
//|                        XAUUSD専用 Fintokeiチャレンジ対応EA v6    |
//|                        勝率向上版（エントリー厳格化）              |
//+------------------------------------------------------------------+
#property copyright "XAUUSD Fintokei EA v6"
#property link      ""
...
int OnInit()
{
   ...
   Print("========================================");
   Print("XAUUSD Fintokei EA v6.0 初期化完了");
   Print("勝率向上版（エントリー厳格化）");
...
void OnDeinit(const int reason)
{
   ...
   Print("XAUUSD Fintokei EA v6.0 終了");
