//+------------------------------------------------------------------+
//|                                       XAUUSD_Fintokei_EA_v7.mq5 |
//|                        XAUUSD専用 Fintokeiチャレンジ対応EA v7    |
//|                        RR比調整版（勝率重視）                      |
//+------------------------------------------------------------------+
#property copyright "XAUUSD Fintokei EA v7"
#property link      ""
...
input group "===== 利確設定（RR調整版） ====="
input bool     UsePartialTP       = true;     // 分割利確を使用
input double   TP1_Percent        = 70;       // 第1利確のポジション比率(%)（増加）
input double   TP1_RR             = 1.5;      // 第1利確のRR比率（縮小）
input double   TP2_RR             = 2.5;      // 第2利確のRR比率（縮小）
input double   MinRRRatio         = 1.5;      // 最小RR比（縮小）
...
int OnInit()
{
   ...
   Print("========================================");
   Print("XAUUSD Fintokei EA v7.0 初期化完了");
   Print("RR比調整・勝率向上版");
...
void OnDeinit(const int reason)
{
   ...
   Print("XAUUSD Fintokei EA v7.0 終了");
