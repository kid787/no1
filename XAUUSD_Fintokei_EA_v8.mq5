//+------------------------------------------------------------------+
//|                                       XAUUSD_Fintokei_EA_v8.mq5 |
//|                        XAUUSD専用 Fintokeiチャレンジ対応EA v8    |
//|                        DD停止10%緩和版（v6ベース）                |
//+------------------------------------------------------------------+
#property copyright "XAUUSD Fintokei EA v8"
#property link      ""
...
input double   DDStopPercent         = 10.0;  // ドローダウン停止レベル(%)【10%に緩和】
...
input int      MinConfluenceCount = 5;        // 最小コンフルエンス数（厳格化）
...
int OnInit()
{
   ...
   Print("========================================");
   Print("XAUUSD Fintokei EA v8.0 初期化完了");
   Print("DD停止10%緩和版（v6ベース）");
...
void OnDeinit(const int reason)
{
   ...
   Print("XAUUSD Fintokei EA v8.0 終了");
