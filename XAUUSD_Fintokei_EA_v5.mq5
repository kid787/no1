//+------------------------------------------------------------------+
//|                                       XAUUSD_Fintokei_EA_v5.mq5 |
//|                        XAUUSD専用 Fintokeiチャレンジ対応EA v5    |
//|                        3連敗停止ルール版                          |
//+------------------------------------------------------------------+
#property copyright "XAUUSD Fintokei EA v5"
#property link      ""
...
input group "===== 連敗停止ルール ====="
input int      MaxConsecutiveLosses  = 3;     // 連敗停止数（この回数連敗で当日停止）
...
int OnInit()
{
   ...
   Print("========================================");
   Print("XAUUSD Fintokei EA v5.0 初期化完了");
   Print("3連敗停止ルール版");
...
void OnDeinit(const int reason)
{
   ...
   Print("XAUUSD Fintokei EA v5.0 終了");
