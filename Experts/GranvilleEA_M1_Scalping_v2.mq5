//+------------------------------------------------------------------+
//|                                  GranvilleEA_M1_Scalping_v2.mq5 |
//|                           Granville's Law M1 Scalping System     |
//|                         High Win Rate Version with Strict Filters|
//+------------------------------------------------------------------+
#property copyright "Granville Gold Trading System"
#property link      ""
#property version   "2.02"
#property description "XAU/USD M1 Scalping EA - Optimized for PF 1.5+"
#property description "Strict filters for higher win rate"
#property description "Target: 60%+ win rate, PF 1.5+"
...
// Scalping Settings - IMPROVED
input double   TakeProfit_Pips = 20.0;            // 15→20 pips
input double   StopLoss_Pips = 10.0;
input double   MinRR_Ratio = 1.8;                 // 1.3→1.8
...
input double   BreakEven_Trigger_Pips = 8.0;      // 5→8 pips
input int      BreakEven_Offset_Pips = 3;         // 2→3 pips
...
{
   Print("========================================");
   Print("Granville M1 Scalping EA v2.02 - High Win Rate");
   Print("========================================");
   Print("Symbol: ", Symbol_to_Trade);
   Print("ADX Min: ", ADX_Min_Level, " (Strengthened)");
