//+------------------------------------------------------------------+
//| GranvilleEA_Enhanced.mq5 |
//| Enhanced version with pyramiding and improved lot calculation |
//| Copyright 2025, Granville EA System |
//+------------------------------------------------------------------+
#property copyright "Copyright 2025, Granville EA System Enhanced"
#property link ""
...
input string EA_Comment = "Granville EA Enhanced"; // EAコメント
...
int OnInit()
{
    ...
    Print("========================================");
    Print("Granville EA Enhanced 初期化成功");
...
void OnDeinit(const int reason)
{
    ...
    Print("Granville EA Enhanced 終了");
}
