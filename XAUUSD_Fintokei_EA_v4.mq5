//+------------------------------------------------------------------+
//|                                       XAUUSD_Fintokei_EA_v4.mq5 |
//|                        XAUUSD専用 Fintokeiチャレンジ対応EA v4    |
//|                        2連敗停止ルール実装版                      |
//+------------------------------------------------------------------+
#property copyright "XAUUSD Fintokei EA v4"
#property link      ""
...
int OnInit()
{
   ...
   Print("========================================");
   Print("XAUUSD Fintokei EA v4.0 初期化完了");
   Print("2連敗停止ルール実装版");
...
void OnDeinit(const int reason)
{
   ...
   Print("XAUUSD Fintokei EA v4.0 終了");
